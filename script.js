...
$(document).ready(function () {
  ...
  var APIKEY = "63b76eb9969f06502871aab8"
  Getform();
  ...
  $("#submit").on("click", function (e) {
    ...
    let contactName = $("#fname").val();
    let contactEmail = $("#email").val();
    let contactMessage = $("#subject").val();
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://student-67bc.restdb.io/rest/feedback  ",
  ...
  function getContacts(limit = 10, all = true) {
    ...
    let settings = {
      "async": true,
      "crossDomain": true,
      "url": "https://student-67bc.restdb.io/rest/student",
  ...
  function updateForm(id, contactName, contactEmail, contactMsg) {
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": `https://student-67bc.restdb.io/rest/student/${id}`,//update based on the ID
      "method": "PUT",
      "headers": {
        "content-type": "application/json",
        "x-apikey": APIKEY,
  ...
  function Getform(){
    ...
    $.ajax(settings).done((response)=>{
      ...
      for(let i =0; i<response.length;i++){
        content = `${content}<div><p>${response[i].Feedback},${response[i].Name}</p></div>`
      }
